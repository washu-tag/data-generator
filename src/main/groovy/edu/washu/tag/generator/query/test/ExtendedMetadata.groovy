        ...
        withDataProcessor(
            new FirstMatchingReportsRadReportResult(
                ...
                [
                    ...
                    'mpi': radiologyReport.hl7Version == ReportVersion.V2_3 ? radiologyReport.patient.legacyPatientId : null,
                    ...
                    'country': radiologyReport.hl7Version == ReportVersion.V2_3 ? '' : 'USA',
                    'orc_2_placer_order_number': radiologyReport.hl7Version == ReportVersion.V2_7 ? radiologyReport.placerOrderNumber.getEi1_EntityIdentifier().value : null,
                    'obr_2_placer_order_number': radiologyReport.placerOrderNumber.getEi1_EntityIdentifier().value,
                    (COLUMN_PATIENT_AGE): String.valueOf(radiologyReport.inferPatientAge()),
                    'principal_result_interpreter': radiologyReport.principalInterpreter?.formatFirstLast()?.toUpperCase(),
                    'assistant_result_interpreter': radiologyReport.hl7Version == ReportVersion.V2_3 ? '[]' : '[' + radiologyReport.assistantInterpreters*.formatFirstLast()*.toUpperCase().join(', ') + ']',
                    'technician': radiologyReport.hl7Version == ReportVersion.V2_4 ? '[]' : "[${radiologyReport.technician.formatFirstLast().toUpperCase()}]".toString(),
                    'orc_3_filler_order_number': radiologyReport.hl7Version == ReportVersion.V2_7 ? radiologyReport.study.accessionNumber : null,
