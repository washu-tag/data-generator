...
class ExtendedMetadata extends TestQuery<BatchSpecification> {
        ...
        withDataProcessor(
            new FirstMatchingReportsRadReportResult(
                ...
                [
                    ...
                    'service_coding_system': radiologyReport.hl7Version == V2_3 ? null : procedureCode.codedTriplet.codingSchemeDesignator,
                    'diagnostic_service_id': getObr24(radiologyReport, procedureCode),
                    'study_instance_uid': radiologyReport.hl7Version == V2_7 ? radiologyReport.study.studyInstanceUid : null,
    ...
    private String getOrc3(RadiologyReport radiologyReport) {
        switch (radiologyReport.hl7Version) {
            case V2_7 -> radiologyReport.study.accessionNumber
            case V2_4 -> null
            case V2_3 -> ''
        }
    }

    private String getObr24(RadiologyReport radiologyReport, ProcedureCode procedureCode) {
        switch (radiologyReport.hl7Version) {
            case V2_7 -> ObrGenerator.derivePrimaryImagingModality(radiologyReport.study)
            case V2_4 -> procedureCode.codedTriplet.codeValue.replaceAll('\\d', '')
            case V2_3 -> ''
        }
    }
